...
public class PasswordValidator {
    public static String validate(String password) {
        ...
        if (!testStr) {
            throw new IllegalArgumentException("Пароль не должен содержать подстроки в любых регистрах: qwerty, 12345, password, admin, user");
        }
        String rsl = "Валидация пройдена";
        return rsl;
    }
